...
class SimpleTest(TestCase):
    ...
    def test_get_subjects(self):
        r =self.client.post('/get_subjects').content
        self.assertIsInstance(json.loads(r),list)

    def test_get_competitionSubjects(self):
        r =self.client.post('/get_competitionSubjects').content
        self.assertIsInstance(json.loads(r),list)
